...
- Allows web applications to convert text to speech
- Key interfaces: SpeechSynthesis, SpeechSynthesisUtterance, SpeechSynthesisVoice
- Common methods: speak(), cancel(), pause(), resume()
- Events: onvoiceschanged, onstart, onend, onerror
