...
They are often used to add unique property keys to objects that won't collide with keys any other code might add to the object, and which are hidden from any mechanisms other code might use to access the object.
