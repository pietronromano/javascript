# Udemy Complete JavaScript Course: Schmedtmann 
- COURSE: https://www.udemy.com/course/the-complete-javascript-course
- SOURCE: https://github.com/jonasschmedtmann/complete-javascript-course

## How to run examples:
- See main README.md file for general instructions
- In VS Code, move the javascript comments tag `/* ... */`in the script.js file to uncomment code
